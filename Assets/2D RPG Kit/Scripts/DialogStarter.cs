...
public class DialogStarter : MonoBehaviour {
	...
	void Update () {
        ...
        if (activateOnAwake || activateOnEnter)
        {
            ...
            if (canActivate && !DialogManager.instance.dialogBox.activeInHierarchy && !Inn.instance.innMenu.activeInHierarchy && !GameMenu.instance.menu.activeInHierarchy||autoActive)
            {
